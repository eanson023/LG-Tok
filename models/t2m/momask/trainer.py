...
class MaskTransformerTrainer:
    ...
    def forward(self, batch_data):
        ...
        # (b, n, q)
        code_idx = self.vq_model.quantize(motion, m_lens, conds)
        m_lens = m_lens // 4
    ...
    def train(self, train_loader, val_loader, eval_val_loader, eval_wrapper, plot_eval):
        ...
        best_fid, best_div, best_top1, best_top2, best_top3, best_matching, best_clip_score, writer = evaluation_transformer(
            ...
            best_matching=100, best_clip_score=-1, eval_wrapper=eval_wrapper,
            plot_func=plot_eval, save_ckpt=False, save_anim=False, model=self.opt.model
        )
        best_acc = 0.
        ...
        while epoch < self.opt.max_epoch:
            ...
            best_fid, best_div, best_top1, best_top2, best_top3, best_matching, best_clip_score, writer = evaluation_transformer(
                ...
                plot_func=plot_eval, save_ckpt=True, save_anim=(epoch%self.opt.eval_every_e==0), model=self.opt.model
            )
